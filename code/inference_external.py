...
parser.add_argument(
    "--data_path",
    type=str,
    default="../dataset/SMU-GC-External-Validation/2020 344例CT(南方医院344)/processed_h5",
...
parser.add_argument(
    "--save_path",
    type=str,
    default="../dataset/SMU-GC-External-Validation/2020 344例CT(南方医院344)/ImageClinical.csv",
